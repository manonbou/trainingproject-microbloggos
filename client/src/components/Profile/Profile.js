...
import LoadingPosts from '../Posts/LoadingPosts' //pour l'icone de chargement
    ...
    componentDidUpdate(prevProps) {
        if (this.props.auth.isAuthenticated) {
            if (prevProps.user && prevProps.user.following !== this.props.user.following) {
                this.props.refreshUserProfile(this.props.match.params.userId) //ou refreshUserProfile // getUserProfile
            }
        }
    }
